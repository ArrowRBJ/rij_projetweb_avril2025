        ...
        <section id="two" class="wrapper style2">
            <div class="inner">
                <div class="box">
                    <div class="content">
                        <?php
                            $R_profil = 'SELECT * FROM t_profil_pfl WHERE cpt_pseudo="' . $_SESSION['login'] . '";';
                            ...
                            if($result2 == false){  
                                ...
                                echo "<p> Pseudo : " . $profil['cpt_pseudo'] . "<br>";
                                echo "Nom : " . $profil['pfl_nom'] . "<br>";
                                echo "Preom : " . $profil['pfl_prenom'] . "<br>";
                                echo "E-mail : " . $profil['pfl_email'] . "<br>";
                                echo "Role : ";
                                if($profil['pfl_role']=='G'){
                                ...
                                echo "Date de création : " . $profil['pfl_date'] . "<br>" ;
                                if($profil['pfl_role']=='G'){
                                    $R_users= "SELECT * FROM t_profil_pfl";
                                    $result3 = $mysqli->query($R_users);
                                    if ($result3 == false){
                                        echo "Error: La requête a échoué <br>";    
                                        echo "Query: " . $sql . "<br>";    
                                        echo "Errno: " . $mysqli->errno . "<br>";    
                                        ...
                                        echo "<br>";
                                        echo "Nombre de comptes :" . $result3->num_rows ;
                                    }
